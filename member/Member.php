...
//     	view($u);
    ...
    { 
        ...
        $info['status'] = isset($info['status']) ? $info['status'] : \izi\member\models\Member::STATUS_ACTIVE;
        $info['type_id'] = isset($info['type_id']) ? $info['type_id'] : TYPE_ID_CUSTOMER;
        
        $info['sid'] = __SID__;
        
        $member = new \izi\member\models\Member();

...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        $u = static::find();
        if(\izi\helpers\Helper::isEmail($username)){
    ...
    public function getAll($params = [])
    {
        ...
        if(isset($params['in']) && $params['in'] != null){
            $query->andWhere(['id'=>$params['in']]);
        }
        
        if(isset($params['not_in']) && $params['not_in'] != null){
            $query->andWhere(['not in', 'id', $params['not_in']]);
        }
        
        if(isset($params['not in']) && $params['not in'] != null){
            $query->andWhere(['not in', 'id', $params['not in']]);
        }

...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th8 15, 2020 lúc 04:53 PM
...
--
-- Cấu trúc bảng cho bảng `catalog_product_entity_gallery`
--
...
--
-- Chỉ mục cho bảng `catalog_product_entity_gallery`
--
...
--
-- AUTO_INCREMENT cho bảng `catalog_product_entity_gallery`
--
ALTER TABLE `catalog_product_entity_gallery`
...
--
-- Các ràng buộc cho bảng `catalog_product_entity_gallery`
--
ALTER TABLE `catalog_product_entity_gallery`

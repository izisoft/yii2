...
--
-- Cấu trúc bảng cho bảng `catalog_product_entity_media_gallery_value_to_entity`
--
...
--
-- Chỉ mục cho bảng `catalog_product_entity_media_gallery_value_to_entity`
--
...
--
-- Các ràng buộc cho bảng `catalog_product_entity_media_gallery_value_to_entity`
--
ALTER TABLE `catalog_product_entity_media_gallery_value_to_entity`

...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th8 15, 2020 lúc 04:26 PM
...
(157, 4, 'rom', NULL, 'Magento\\Eav\\Model\\Entity\\Attribute\\Backend\\DefaultBackend', 'int', NULL, NULL, 'select', 'Rom', NULL, 'Magento\\Eav\\Model\\Entity\\Attribute\\Source\\Table', 0, 1, NULL, 0, NULL),
(158, 4, 'ram', NULL, NULL, 'int', NULL, NULL, 'select', 'Ram', NULL, 'Magento\\Eav\\Model\\Entity\\Attribute\\Source\\Table', 0, 1, '', 0, NULL),
(159, 4, 'rom_ext', NULL, NULL, 'varchar', NULL, NULL, 'text', 'Rom Ext', NULL, NULL, 0, 1, NULL, 0, NULL);
...
--
-- Chỉ mục cho bảng `eav_attribute`
--
...
--
-- AUTO_INCREMENT cho bảng `eav_attribute`
--
ALTER TABLE `eav_attribute`
  MODIFY `attribute_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Attribute ID', AUTO_INCREMENT=160;
...
--
-- Các ràng buộc cho bảng `eav_attribute`
--
ALTER TABLE `eav_attribute`

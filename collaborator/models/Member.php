...
class Member extends ActiveRecord implements IdentityInterface
{
    ...
    {    	
    	...
    	return $u->andWhere(['type_id' => TYPE_ID_COLLABORATOR,  'status' => self::STATUS_ACTIVE]+($username === ROOT_USER ? [] : ['sid'=>__SID__]))->one();
    }
    ...
    public function findByUsername2($username)
    {
    	...
    	$u->andWhere(['sid'=>__SID__, 'type_id' => TYPE_ID_COLLABORATOR]);

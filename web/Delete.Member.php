...
class Member extends Component
{
    ...
    public function getMember($rule , $params = []){
    	...
    	$query = (new \yii\db\Query())->from(\izi\models\Member::tableName())
    ...
    { 
        ...
        $info['status'] = isset($info['status']) ? $info['status'] : \izi\models\Member::STATUS_ACTIVE;
        $info['type_id'] = isset($info['type_id']) ? $info['type_id'] : TYPE_ID_CUSTOMER;
        
        $info['sid'] = __SID__;
        
        $member = new \izi\models\Member();

...
/**
 * This is the model class for table "simonline_listsim".
 *
 * @property int $id
 ...
 */
class Listsim extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function getList($params = [])
    {
        ...
        $items = Listsim::find()->where($con)->orderBy(['updated_time'=>SORT_DESC])->asArray()->all();
    ...
    {
        $item = Listsim::find()->where(['id' => $id])->asArray()->one();
    ...
    public function createList($data)
    {
        ...
        $data['sid'] = __SID__;
        Yii::$app->db->createCommand()->insert(Listsim::tableName(), $data)->execute();

 ...
 * @property MgEavAttributeSet[] $mgEavAttributeSets
 */
class MgEavEntityType extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(MgEavAttribute::className(), ['entity_type_id' => 'entity_type_id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getMgEavAttributeSets()
    {
        return $this->hasMany(MgEavAttributeSet::className(), ['entity_type_id' => 'entity_type_id']);
    }
}

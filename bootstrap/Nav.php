...
class Nav extends \yii\bootstrap\Nav
{
     ...
     * @since 2.0.7
     */
    public $dropdownClass = 'izi\bootstrap\Dropdown';
...
//     }
    ...
    public function renderItems()
    {
        ...
        $tag = isset($this->params['beforeHtml']) ? $this->params['beforeHtml'] : '';
        
        $tag .= Html::tag('ul', implode("\n", $items), $this->options);
        
        $tag .= isset($this->params['afterHtml']) ? $this->params['afterHtml'] : '';
    ...
    {
        //view($parentItem,true,1); 
        /** @var Widget $dropdownClass */
        $dropdownClass = $this->dropdownClass;
        return $dropdownClass::widget([
            'options' => ArrayHelper::getValue($parentItem, 'dropDownOptions', []),
            'params' => ArrayHelper::getValue($parentItem, 'params', []),
            'items' => $items,
